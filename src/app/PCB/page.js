...
const Header = () => (
  <header className="py-20 bg-gray-900 text-white text-center">
    <h1 className="text-4xl font-bold">Multipurpose PCB</h1>
    <p className="mt-2 text-lg text-gray-400">
      A versatile Printed Circuit Board designed to enhance functionality in Arduino-based projects.
    </p>
  </header>
);
  ...
  <section className="py-20 bg-gray-900 text-white px-4 sm:px-6 lg:px-8">
    <div className="max-w-7xl mx-auto">
      ...
      <p className="text-gray-400 mb-12 leading-relaxed">
        The <strong>Multipurpose PCB</strong> is a custom-designed printed circuit board made to simplify prototyping
        and testing for electronics and Arduino-based projects. It offers integrated connections, modular design, and
        support for multiple sensors and modules — making hardware development faster and cleaner.
      </p>

      <h2 className="text-2xl font-bold mb-8 border-l-4 border-blue-500 pl-4">Key Features</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <FeatureCard title="Universal Compatibility" description="Supports multiple Arduino models, sensors, and modules." />
        <FeatureCard title="Compact Design" description="Saves space while maintaining clear, organized connections." />
        <FeatureCard title="Solder-free Prototyping" description="Allows fast testing and iteration without permanent soldering." />
        <FeatureCard title="Durable and Reliable" description="Made from high-quality materials for long-lasting use and stability." />
      </div>
    </div>
  </section>
);
...
const Testimonials = () => (
  <section className="py-20 bg-gray-800 text-white px-4 sm:px-6 lg:px-8">
    <div className="max-w-7xl mx-auto">
      <h2 className="text-2xl font-bold mb-8 border-l-4 border-blue-500 pl-4">What Our Users Say</h2>
      <div className="space-y-8">
        <TestimonialCard
          name="Ravi Sharma, IoT Developer"
          quote="The Multipurpose PCB made my prototyping process so much faster. No messy wires — just plug and play!"
        />
        <TestimonialCard
          name="Neha Patel, Engineering Student"
          quote="Perfect for college projects! It’s reusable and fits with many components easily."
        />
      </div>
    </div>
  </section>
...
const TestimonialCard = ({ name, quote }) => (
  <div className="p-6 bg-gray-900 rounded-lg shadow-2xl border-l-4 border-blue-500">
    ...
    <p className="text-sm mt-2 text-gray-500">1 month ago</p>
  </div>
);
...
const WhyChoose = () => (
  <section className="py-20 bg-gray-900 text-white px-4 sm:px-6 lg:px-8">
    <div className="max-w-7xl mx-auto">
      <h2 className="text-2xl font-bold mb-8 border-l-4 border-blue-500 pl-4">Why Choose Our PCB?</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <WhyChooseCard title="Simplifies Development" description="Reduces wiring complexity and speeds up project testing." />
        <WhyChooseCard title="Reusable Design" description="Use it for multiple projects without redesigning the circuit each time." />
        <WhyChooseCard title="Professional Finish" description="Gives your DIY projects a neat, production-grade look." />
      </div>
    </div>
  </section>
);
...
const CTASection = () => {
  ...
  return (
    <section className="my-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-gray-900/90 rounded-3xl shadow-lg text-center py-16 relative overflow-hidden">
      <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">Want to Integrate This PCB?</h2>
      <p className="text-gray-400 mb-8 text-lg sm:text-xl">Let’s discuss your project requirements and customization options.</p>
      <button
...
export default MultipurposePCB;
